<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../../../../../project-perso-dqh2/App/Zyrass/Models/index.php">Aide <small class="text-warning">DQH 2</small></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu jqueryFadeIn">
                        <li class="dropdown-header text-center">Première partie</li>
                        <li class="divider"></li>
                        ...
                        <li class="dropdown-header text-center">Seconde partie</li>
                        <li class="divider"></li>
                        ...
                        <li role="separator" class="divider"></li>
                        <li class="dropdown-header text-center">Gragon pour vous servir</li>
                        <li class="divider"></li>
                        ...
                        <li role="separator" class="divider"></li>
                        <li class="dropdown-header text-center">Les autres batailles</li>
                        <li class="divider"></li>
